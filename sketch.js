...
function setup() {
  ...
  canvas.position (displayWidth/2-150,displayHeight/2-100)
...
function draw() {
  ...
  stroke(5)
  fill("black")
  text("Score: "+ score,450, camera.position.y-80);
...
//  camera.position.x = 600;
  ...
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(600,camera.position.y+110,10,40);
    //obstacle.debug = true;
